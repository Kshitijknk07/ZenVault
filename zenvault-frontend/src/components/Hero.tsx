          ...
          <div className="lg:col-span-6 xl:col-span-5 flex flex-col justify-center">
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight">
                ...
                <span className="block text-gradient">for your digital life</span>
              </h1>
          ...
          <div className="mt-16 lg:mt-0 lg:col-span-6 xl:col-span-7">
            <div className="relative">
              ...
              <div className="relative grid grid-cols-2 gap-6 sm:gap-8 p-4">
                <div className="glass-card p-6 rounded-xl flex flex-col items-center transform transition-all duration-300 hover:scale-105 hover:shadow-soft-xl">
