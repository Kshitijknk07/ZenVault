      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Secure cloud storage with uncompromising privacy and intuitive design.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#security" className="text-sm text-muted-foreground hover:text-accent transition-colors">Security</a></li>
              <li><a href="#" className="text-sm text-muted-foreground hover:text-accent transition-colors">Enterprise</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-sm text-muted-foreground hover:text-accent transition-colors">Jobs</a></li>
              <li><a href="#" className="text-sm text-muted-foreground hover:text-accent transition-colors">Press</a></li>
              <li><a href="#" className="text-sm text-muted-foreground hover:text-accent transition-colors">Partners</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-border/50 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex gap-4 mt-4 md:mt-0">
            <a href="#" className="text-muted-foreground/70 hover:text-accent transition-colors">
