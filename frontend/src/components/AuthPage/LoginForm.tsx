  ...
  return (
    ...
    >
      ...
      <div className="grid gap-6">
        ...
        <div className="grid gap-2">
          <div className="flex items-center">
            ...
            <a
              href="#"
              className="ml-auto text-sm text-[#3b82f6] hover:text-[#3b82f6]/80 underline-offset-4 hover:underline"
            >
        ...
        <div className="relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t after:border-[#3b82f6]/20">
          <span className="relative z-10 bg-[#2c2c2e] px-2 text-white/70">
            Or continue with
          </span>
        </div>
        <Button
          variant="outline"
          className="w-full border-[#3b82f6]/30 text-white hover:bg-[#3b82f6]/10 transition-colors"
          type="button"
        >
          <svg
      ...
      <div className="text-center text-sm text-white/70">
        ...
        <a
          href="#"
          className="text-[#3b82f6] hover:text-[#3b82f6]/80 underline underline-offset-4"
        >
          Sign up
        </a>
      </div>
