...
export function SignupForm({
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <form onSubmit={handleSubmit}>
        <div className="flex flex-col gap-6">
          ...
          <div className="relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t after:border-white/10">
            <span className="relative z-10 bg-[#2c2c2e] px-2 text-white/50">
              Or
            </span>
          </div>
      ...
      <div className="text-balance text-center text-xs text-white/50 [&_a]:text-[#3b82f6] [&_a]:underline [&_a]:underline-offset-4 hover:[&_a]:text-[#3b82f6]/80">
